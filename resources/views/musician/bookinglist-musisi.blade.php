    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
         <ul class="nav nav-tabs">
            <li class="active"><a href="{{url('listsewa')}}">Request </a></li>
            <li><a href="{{url('listsewa/musisi/approve')}}">Approve </a></li>
			...
			@foreach($sewamusisi as $_sewamusisi)
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						@elseif($_sewamusisi->status_request == 0)
							<p><a href={{url('confirm-musisi/'.$_sewamusisi->id)}}>Terima</a> | <a href={{url('cancel-musisi/'.$_sewamusisi->id)}}>Tolak</a></p>
						@endif
					</div>
				</div>
			@endforeach	
